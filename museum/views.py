...
def object_list(request):
    q = (request.GET.get("q") or "").strip() #cautare
    ...
    # queryset cu toate obiectele
    qs = ArtObject.objects.all().order_by("id")

    # qs in functie de filtre
    ...
    page_obj = paginator.get_page(request.GET.get("page")) # pg curenta

    # trimitem catre template
